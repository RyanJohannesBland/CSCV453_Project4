...
typedef struct statement_node {
    // 1 is return, 2 is assignment, 3 is functioncall, 4 is expression.
    int type;
    expr_node *expr_node;
...
statement_node *make_statement_node(int type, expr_node *exp_node, assignment_node *assignment_node, function_node *function_node);
